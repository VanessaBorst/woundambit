...
# Code adapted from
# https://github.com/yan-hao-tian/VW/blob/master/mmsegmentation-custom/mmseg/models/decode_heads/vw_head.py
# Changed:
# VWHead: norm_cfg is dynamically determined based on the setting (multi-gpu or not): syncBN vs BN
# Removed VWCityHead
