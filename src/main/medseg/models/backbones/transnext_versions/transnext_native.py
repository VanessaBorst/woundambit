...
# https://github.com/DaiShiResearch/TransNeXt/blob/main/segmentation/upernet/transnext_native.py
...
class TransNeXt(nn.Module):
    ...
    def __init__(self, img_size=224, pretrain_size=None, window_size=[3, 3, 3, None],
                 ...
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], num_stages=4, pretrained_filename=None,
