...
# (https://github.com/open-mmlab/mmpretrain/blob/ee7f2e88501f61aa95c742dd5f429f039935ee90/mmpretrain/models/utils/norm.py)
# Use mmengine MODELS instead of MMPretrains Extension
...
class LayerNocrm2d(nn.LayerNorm):
